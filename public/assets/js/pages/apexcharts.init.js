...
options = {
  ...
  series: [{
    name: "Amount",
    //data: [2, 3.2, 5, 10.1]
     data: [_carIssueSumAmount, _carServiceSumAmount, _carFineSumAmount, _carCrasheSumAmount]
  }],
  colors: ["#556ee6"],
  grid: {
    borderColor: "#f1f1f1"
  ...
  xaxis: {
    categories: ["issue", "service", "Traffic Fine", "crashe"],
    position: "top",
    labels: {
      offsetY: -18
    },
  ...
  title: {
    text: _carProblemsOf+_currentMonth,
    floating: !0,
    offsetY: 330,
    align: "center",
    style: {
...
options = {
  ...
  series: [_totalBooking, _upComingBooking, _pastBooking, _currentBooking, _availableCar,_bookedCar,_totalUser,_totalCar],
  labels: [_totalBookingTranslation,_upcomingBookingTranslation,_pastBookingTranslation,_currentBookingTranslation,_availableCarsTranslation,_bookedCarsTranslation,_totalUserTranslation,_totalCarsTranslation],
  colors: ["#f66d44", "#feae65", "#e6f69d", "#aadea7","#C6D68F", "#64c2a6", "#E8A09A","#2d87bb"],
  legend: {
    show: !0,
    position: "bottom",
...
options = {
  ...
  series: [_bookedCar, _availableCar],
  labels: [_bookedCarsTranslation,_availableCarsTranslation],
