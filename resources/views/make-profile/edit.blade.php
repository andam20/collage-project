    ...
    <div class="col-xl-12">
        <div class="card">
            <div class="card-body">
                ...
                @endif
                <form class="needs-validation" novalidate action="{{ route('company-profile.update', $companyProfile->id) }}" method="POST"
                            ...
                            <div class="row mb-4">
                                ...
                                <div class="col-sm-9">
                                    <input type="date" class="form-control" id="dob" name="dob"
                                        value="{{ $companyProfile->dob }}" required>
                                    <div class="valid-feedback">
                                        @lang('validation.good')
                                    </div>
                                    <div class="invalid-feedback">
                            ...
                            <div class="row mb-4">
                                ...
                                <div class="col-sm-9">
                                    <select class="form-control select2" id="gender" name="gender" required>
                                        <option value="male" @selected(old('gender', $companyProfile->gender) == 'male')> male
                                        </option>
                                        <option value="female" @selected(old('gender', $companyProfile->gender) == 'female')>female
                                        </option>
                                    </select>
                                    <div class="valid-feedback">
                                        @lang('validation.good')
                            ...
                            <div class="row mb-4">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" id="desc" name="desc"
                                        value="{{ $companyProfile->desc }}" required>
                                    <div class="valid-feedback">
                                        @lang('validation.good')
                                    </div>
                                    <div class="invalid-feedback">
                            ...
                            <div class="row mb-4">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" id="work_type" name="work_type"
                                        value="{{ $companyProfile->work_type }}" required>
                                    <div class="valid-feedback">
                                        @lang('validation.good')
                                    </div>
                                    <div class="invalid-feedback">
...
<div class="images" width="100px" height="100px">
    <img src="{{$companyProfile->getFirstMediaUrl('images')}}" title="Cover" alt="Cover" width="100px" height="100px">
</div>
